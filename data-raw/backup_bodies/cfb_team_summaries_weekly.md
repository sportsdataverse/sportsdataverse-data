College Football team summaries as of the END OF EACH REGULAR-SEASON WEEK. LONG FORMAT: one asset per season carrying a `through_week` column with every week's cumulative snapshot stacked.
